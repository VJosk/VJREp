...
{
    public class SessiasController : Controller
    {
        private readonly ASp_YankContext _context;

        public SessiasController(ASp_YankContext context)
        {
            _context = context;
        }
